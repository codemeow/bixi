...
u16_net bxi_u162u16_net(u16 value) {
    return bxi_u162u16_be(value);
}

i16_net bxi_i162i16_net(u16 value) {
    return bxi_i162i16_be(value);
}

u32_net bxi_u322u32_net(u32 value) {
    return bxi_u322u32_be(value);
}

i32_net bxi_i322i32_net(u32 value) {
    return bxi_i322i32_be(value);
}
