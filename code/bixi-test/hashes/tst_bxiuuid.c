...
{
    char buffer[50];
    bxi_uuid_t bf = { 0x99, 0xbd, 0xd9, 0x12, 0x41, 0xcd, 0x40, 0x72,
...
static void test_hashes_uuidv3(void)
{
    char buffer[50];
    bxi_uuid_t res;
    bxi_uuid_t ns = { 0x99, 0xbd, 0xd9, 0x12, 0x41, 0xcd, 0x40, 0x72,
                      0xa9, 0x65, 0x17, 0x44, 0x7b, 0x2f, 0xd1, 0x89 };
...
{
    bxi_uuid_t cm1 = { 0xff, 0xee, 0xdd, 0xcc, 0xbb, 0xaa, 0x99, 0x88,
                   0x77, 0x66, 0x55, 0x44, 0x33, 0x22, 0x11, 0x00 };
    bxi_uuid_t cm2 = { 0xff, 0xee, 0xdd, 0xcc, 0xbb, 0xaa, 0x99, 0x88,
